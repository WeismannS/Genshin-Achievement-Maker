...
function genshinAchievement(text) {
  return __awaiter(this, void 0, void 0, function () {
    var s, space, Lines, canvas, ctx, myimg;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          (0, canvas_1.registerFont)(path.join(__dirname, '..', 'lib', 'assets', 'zh-cn.ttf'), { family: 'genshin' });
          s = text.trim();
          ...
          space = ('"' + s).slice(0, 25).lastIndexOf(' ');
          Lines = [
          ...
          return [
            4 /*yield*/,
            (0, canvas_1.loadImage)(path.join(__dirname, '..', 'lib', 'assets', 'row-2-column-1.png')),
          ];
        case 1:
          myimg = _a.sent();
